...
def parse_args():
    ...
    parser.add_argument('--checkpoint-path', dest='checkpoint_path', default=r'E:\project\LLM\PatternAbductive\ckpt\Qwen2.5-0.5B\DBpedia50-default-8-11000-rl-text2text.pth')
    ...
    parser.add_argument('--obs', default='[BBC]')
    ...
    parser.add_argument('--dont_use_pretrained_text_model', action='store_false')
    parser.add_argument('--dont_disable_text_extra_tokens', action='store_false')
    parser.add_argument('--dont_use_peft', action='store_false')
